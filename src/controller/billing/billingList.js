...
const getBillingList = async function (req, res) {
    try {
        ...
        const findBillingDetails = await billingModel.find(req.query).select({ _id: 1, user: 1, location: 1, price: 1, availability: 1, facilities: 1})
